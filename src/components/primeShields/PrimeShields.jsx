                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                ...
                                <div className="container-escudos" id="divEscudos">
                                    ...
                                    <a href="#none" id="Hexuno" className="Hexagono1" onClick={this.hexagono}>
                                        <img src="https://i.ibb.co/bHQTrMx/Hexagono-3-0.png" alt="c-521" />
                                    </a>

                                    <a href="#none" id="Hexdos" className="Hexagono2" onClick={this.hexagonoDos}>
                                        <img src="https://i.ibb.co/rwqddV7/Hexagono-prueba.png" alt="c-522" />
                                    </a>

                                    <a href="#none" id="Hextres" className="Hexagono3" onClick={this.hexagonoTres}>
                                        <img src="https://i.ibb.co/T1QRx1T/Hexagono-2-0.png" alt="c-523" />
                                    </a>

                                    <a href="#none" id="Hexcuatro" className="Hexagono4" onClick={this.hexagonoCuatr}>
